...
class Trainer:
    ...
    def __init__(self, cfg, use_gpu=True, debug=False):
        ...
        self.predicate2id, self.id2predicate = self.load_mapping(cfg.schema_path)
        self.model = Net.from_pretrained(cfg.bert_path, head_type='EfficientGlobalPointer', num_class=len(self.predicate2id),
                                         max_len=256)
